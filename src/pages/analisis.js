...
import { useFetch, useSearchHeroes, usePageTransition } from '../hooks';
  ...
  return (
    <>
      ...
      {transitions.map(({ item, key, props }) => {
        return (
          <animated.main className='pt-2 mx-2 animated fadeIn faster lg:grid lg:grid-cols-12 lg:gap-2' key={key} style={props}>
