      ...
      <nav className='w-full flex items-center justify-between flex-wrap'>
        ...
        <div className='header_content truncate w-full block flex-grow lg:flex lg:items-center lg:w-auto text-center'>
          <div className='text-sm lg:flex-grow'>
            <Link onClick={handleMenu} to='/' className='block mt-4 lg:inline-block lg:mt-0 text-white hover:text-black lg:mr-4'>
              Home
            </Link>
            <Link onClick={handleMenu} to='/guias' className='block mt-4 lg:inline-block lg:mt-0 text-white hover:text-black lg:mr-4'>
              Guias
            </Link>
            <Link onClick={handleMenu} to='/alianzas' className='block mt-4 lg:inline-block lg:mt-0 text-white hover:text-black lg:mr-4'>
              Alianzas
            </Link>
            <Link onClick={handleMenu} to='/analisis' className='block mt-4 lg:inline-block lg:mt-0 text-white hover:text-black'>
              Analisis de Heroes
            </Link>
          </div>
        </div>
